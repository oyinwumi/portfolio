...
const projectList = [ 
    {title:'Finsweet', image: Citrone, id:'6', backgroundColor: '#CEFFE2', borderRadius: '#CEFFE2', 
   ...
   {title:'Citrone', image: Citrone, id:'5', backgroundColor: '#EFF1F7', borderRadius: '#EFF1F7', 
   ...
   link: 'https://citrone-redesign-crater.vercel.app/'
    ...
    {title:'Fetch User', image: FetchUsers, id:'3',    backgroundColor: '##D0F3FF', borderRadius: '#D0F3FF',
    ...
    {title:'Personal Website',  image: WebImage, id: '1', backgroundColor: '#FFDBCC', borderRadius: ' #FFDBCC',
