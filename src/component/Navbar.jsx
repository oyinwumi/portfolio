...
const Navbar = () => {
  ...
  return (
    <nav style={{backgroundColor: bgcolor}} className={`  bg-blu font-font w-full h-[88px]  flex justify-between lg:px-[124px] md:px-28 px-8 text-white text-xl items-center border-b-0`}>
        ...
        <ul style={{backgroundColor: bgcolor , color: color}} className={` flex lg:flex-row md:flex-col flex-col justify-center px-4 md:z-50 z-50 lg:static  md:absolute absolute  right-0 lg:w-auto md:w-full w-full bg-blu  text-2xl
