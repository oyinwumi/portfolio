...
const Navbar = () => {
  ...
  return (
    <nav className=' w-full h-[88px] bg-blu flex justify-between lg:px-[124px] md:px-28 px-8 text-white text-xl items-center '>
        <div className=' '>
        ...
        <ul className={` flex lg:flex-row md:flex-col flex-col justify-center px-4 md:z-50 z-50 lg:static  md:absolute absolute  right-0 lg:w-auto md:w-full w-full  bg-blu  text-2xl
         md:pb-0 pb-12   lg:py-10 md:py-6 py-6 md:opacity-100 transition-all ease-in duration-500 ${open ? 'top-20' : 'top-[-490px]'} `}>
