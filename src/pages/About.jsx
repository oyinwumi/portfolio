...
const About = () => {
  return (
    ...
    <div className='justify-center'>
      <img src={Oyin} alt={Oyin} className=' mx-auto items-center w-auto xl:mt-0 lg:mt-0 md:mt-0 mt-0  ' />
    </div>        
    ...
    <div className=' text-blu flex lg:flex-row md:flex-col items-center flex-col lg:gap-5 md:gap-0 gap-0 w-full'>
                <h2 className='lg:text-[48px] md:text-[30px] text-[22px] font-open lg:order-1 md:order-2 order-2 lg:mb-0 md:mb-8 mb-8'>About</h2>
              ...
              <p className='lg:text-lg md:text-[16px] text-[16px]  font-font leading-8  justify-center text-justify mt-10'>I am a graduate of Microbiology. My interest in software development started during my National Youth service Corps through a friend who has a degree in computer science graduate. I took computer programming language as part of my undergraduate course (FORTRAN) even though it doesnt interest me much then i still passed it with A.
