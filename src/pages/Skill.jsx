...
const Skill = () => {
  return (
    ...
    <div className='text-[#00132D] font-font lg:text-[60px] md:text-3xl text-3xl justify-center   text-center grid grid-cols-6 lg:gap-4 md:gap-4 gap-4 lg:w-[70%] mdw-full w-full mx-auto mt-10 '>
