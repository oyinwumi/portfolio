...
const Skill = () => {
  return (
    ...
    <div className='lg:text-[32px] md:text-[28px] text-[24px] text-blu flex lg:flex-row md:flex-col flex-col items-center justify-center lg:gap-5 md:gap-0 gap-0 w-full'>
       <h2 className='lg:text-[32px] md:text-[28px] text-[24px]font-open lg:order-1 md:order-2 order-2 lg:mb-0 md:mb-8 mb-8 fill-blu'>My Skills</h2>
    ...
    <motion.div animate={{x: [0,400,-200] }}  transition={{ duration:3, repeat:Infinity , ease: 'linear', delay:3 }}  className='text-blu font-font lg:text-[60px] md:text-3xl text-3xl justify-center   text-center grid grid-cols-6 lg:gap-4 md:gap-4 gap-4 lg:w-[80%] md:w-full w-full mx-auto items-center mt-10 '>
