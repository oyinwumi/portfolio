...
const Skill = () => {
  return (
    ...
    <motion.div animate={{x: [0,-1500,800] }}  transition={{ delay: 1.5, duration:25, ease: 'linear', repeat: 'infinity' , repeatType:'mirror'}}  className='text-blu font-font text-[60px] flex justify-center lg:gap-12 md:gap-10 gap-8 w-full   mt-10 '>
